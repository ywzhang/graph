...
/*                JSONObject json1 = new JSONObject(true);
                ...
                JSONObject json1 = new JSONObject(true);
                json1.put("id",UUID.randomUUID().toString().replace("-", ""));
                json1.put("category",5);
                json1.put("level",3);
                json1.put("name",person.getGender());
                json1.put("value",null);
                json1.put("label",person.getGender());
                json1.put("flag",true);

                JSONObject json2 = new JSONObject(true);
                json2.put("id",UUID.randomUUID().toString().replace("-", ""));
                json2.put("category",6);
                json2.put("level",3);
                json2.put("name",person.getIdentity());
                json2.put("value",null);
                json2.put("label",person.getIdentity());
                json2.put("flag",true);

                JSONObject json3 = new JSONObject(true);
                json3.put("id",UUID.randomUUID().toString().replace("-", ""));
                json3.put("category",7);
                json3.put("level",3);
                ...
                json5.put("category",9);
                json5.put("level",3);
                json5.put("name",person.getAddress());
                json5.put("value",null);
                json5.put("label",person.getAddress());
                json5.put("flag",true);
